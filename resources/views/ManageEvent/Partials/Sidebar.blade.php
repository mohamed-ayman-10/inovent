<aside class="sidebar sidebar-left sidebar-menu mt-5">
    <section class="content">
        ...
        <ul id="nav_event" class="topmenu">
            ...
            <li class="{{ Request::is('*promote*') ? 'active' : '' }} hide">
                <a href="{{ route('showEventPromote', ['event_id' => $event->id]) }}">
        ...
        <ul id="nav_event" class="topmenu">
            ...
            <li class="{{ Request::is('*surveys*') ? 'active' : '' }}">
                <a href="{{ route('showEventSurveys', ['event_id' => $event->id]) }}">
            ...
            <li class="{{ Request::is('*widgets*') ? 'active' : '' }}">
                <a href="{{ route('showEventWidgets', ['event_id' => $event->id]) }}">
